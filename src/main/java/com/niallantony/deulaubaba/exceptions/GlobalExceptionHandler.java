...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleBadRequestException(BadPageRequestException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(Map.of("message", ex.getMessage()));
    }

    @ExceptionHandler(InvalidCommentPostException.class)
    public ResponseEntity<?> handleInvalidCommentPostException(InvalidCommentPostException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(Map.of("message", ex.getMessage()));
    }
